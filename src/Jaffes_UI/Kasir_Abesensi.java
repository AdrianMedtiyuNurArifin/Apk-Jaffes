 ...
 * @author Adrian MNA
 */
public class Kasir_Abesensi extends javax.swing.JFrame {

    /**
     * Creates new form Kasir_Abesensi
     */
    public Kasir_Abesensi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Menu Absensi");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 130, 30));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kasir_Abesensi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kasir_Abesensi().setVisible(true);
            }
        });
    }
